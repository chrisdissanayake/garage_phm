...
The following is an automated procedure that cleans and segments the signal into idle, torsion coil, and impulse responses. 

### Extract Torsion Coil Response

![](./man/figures/lifecycle-stable.svg)

The first step is to smooth the signal, and a machine learning method is used to isolate the torsion coil unwinding and winding scenarios. 
