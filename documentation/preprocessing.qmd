...
Verify the filter with simulated data with known spikes:
...
The choice of n should be the minimum odd value that will produce the final segmentation on the baseline signal.
